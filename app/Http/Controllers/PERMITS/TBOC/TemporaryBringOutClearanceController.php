...
namespace App\Http\Controllers\PERMITS\TBOC;
...
class TemporaryBringOutClearanceController extends Controller
{
        ...
        public function store(Request $request)
    {
       ...
       $price = isset($form['amount']) 
        ...
        'IS_number' => '',
        'price' => $price,
        'form_type' => 'Temporary-Bring-Out-Clearance',
    ...
    return response()->json([
        'message' => 'Temporary-Bring-Out-Clearance created successfully',
        'gatePass' => $gatepass,
    ]);
    }
}
