...
namespace App\Http\Controllers\PERMITS\BIC;
...
class BringInClearanceController extends Controller
{
    ...
    return response()->json([
        'message' => 'Bring-In-Clearance created successfully',
        'gatePass' => $gatepass,
    ]);
    }
}
