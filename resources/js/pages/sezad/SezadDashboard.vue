...
usersTemp.value = usersTemp.value.map((u) => ({
    ...u,
    locator: Array.isArray(u.locator)
        ? u.locator
        : (() => {
              try {
                  return JSON.parse((u.locator as any) || '[]');
              } catch {
                  return [];
              }
          })(),
...
const businessTypeMap = computed(() =>
    Object.fromEntries(
        businessTypes.value.map((bt) => [bt.id, bt.description]),
    ),
);
        ...
        children: [
            {
                ...
                children: [
                    { name: 'Gate Clearance', href: '/clearance/gatepass' },
                    {
                        ...
                        href: '/sezad/clearances/bring-in',
                    },
                    {
                        name: 'Bring-Out Clearance',
                        href: '/clearance/bring-out',
                    },
                    {
                        name: 'Temporary Bring-Out Clearance',
                        href: '/clearance/temp-bring-out',
                    },
                    {
                        name: 'Local Purchase Clearance',
                        href: '/clearance/temp-bring-out',
                    },
                    { name: 'Storage Clearance', href: '/clearance/storage' },
                    {
                        name: 'Workflow Access Clearance',
...
// let navItems: NavLink[] = sezadManager
//     ? fullNavItems
//     : oneStopActionCenter
//       ? fullNavItems
//       : [];
...
const isRemarksDisabled = computed(() => {
    ...
    return (
        ...
        selectedUser.value.status === 'disapproved'
    );
});
...
//         return (
//             !((selectedUser.value.remark ?? '').trim().length > 0) ||
//             loading.value
//         );
//     }
...
<template>
    <AppLayout>
        ...
        <nav class="sticky top-0 right-0 left-0 z-40 bg-white shadow-md">
            <div
                    ...
                    >
                        ...
                        <div v-else>
                            ...
                            <div
                                ...
                                class="absolute mt-2 rounded bg-white p-2 shadow-lg"
                            >
        ...
        <main class="min-h-screen bg-gray-100 p-6">
            ...
            >
                <!-- Title -->
                <h1 class="mb-6 text-2xl font-bold text-[#0f75bc]">
                    SEZAD – New Users Application
                </h1>
                ...
                <input
                    ...
                    type="text"
                    placeholder="Search..."
                    class="w-full rounded-lg border border-gray-300 px-3 py-2 text-black placeholder-gray-500 focus:ring-2 focus:ring-blue-400 focus:outline-none md:w-64"
                />
            </div>
            <!-- Table -->
            <EasyDataTable
                ...
                show-index
                clickable
                @click-row="openRemarksModal"
                class="rounded-lg border border-gray-200 shadow"
            >
                ...
                <template #item-business_type="{ business_type }">
            ...
            <transition name="fade">
                ...
                >
                    ...
                    >
                        ...
                        <div
                            v-if="loading"
                            class="absolute inset-0 z-50 flex items-center justify-center rounded-2xl bg-white/60"
                        >
                            <div
                        ...
                        >
                        <textarea
                            v-model="selectedUser.remark"
                            rows="4"
                            :disabled="isRemarksDisabled"
                            class="w-full rounded border p-2 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:opacity-50"
                        >
                        </textarea>
                        ...
                        <div class="mt-4 flex justify-end space-x-3">
                            <button
                                @click="closeModal"
                                class="w-full rounded border bg-gray-100 p-2 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                Close
                            </button>
                            ...
                            <button
                                ...
                                :disabled="isDisapproveDisabled"
                                class="rounded bg-red-500 px-4 py-2 text-white disabled:cursor-not-allowed disabled:bg-red-300"
                                :class="
                                    !isRemarkValid || loading
                            ...
                            <button
                                ...
                                :disabled="isDisapproveDisabled"
                                class="rounded bg-green-500 px-4 py-2 text-white disabled:cursor-not-allowed disabled:bg-green-300"
                                :class="
                                    !isRemarkValid || loading
