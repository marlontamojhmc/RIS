    ...
    >
        ...
        <div class="flex items-start justify-between border-b pb-4">
            <div class="space-y-1">
                ...
                <input
                    v-model="form.title"
                    placeholder="Gate Clearance"
                    class="w-64 border-b border-gray-300 text-2xl font-extrabold uppercase"
                />
            </div>
            <div class="space-y-1 text-right text-sm">
                <div>
                    ...
                    <input
                        ...
                        class="w-32 border-b border-gray-300 focus:border-blue-500 focus:outline-none"
                    />
                </div>
...
const form = reactive({
    form_id: props.application.form_id,
...
const submitForm = async () => {
    ...
    try {
        const res = await axios.post('/permits/Lpc/submit', formData, {
            headers: { 'Content-Type': 'multipart/form-data' },
        });
        toast.success(`${form.title} Clearance submitted successfully!`);
